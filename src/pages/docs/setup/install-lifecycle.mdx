...
<Image
  src="/setup/app-installed.png"
  alt="Lifecycle welcome page confirming that the application is running."
  width={1890}
  height={1089}
/>
...
<Image
  ...
  alt="kubectl output showing the Lifecycle domain and wildcard TLS certificates in the Ready state."
  width={2572}
  height={844}
  ratio={2572 / 844}
/>
