...
- Navigate to your installed Lifecycle app at `https://app.<your_domain>/setup` (replace `<your_domain>` with your actual domain. e.g. `https://app.0env.com/setup`).
  <Image
    src="/setup/github-app-setup.png"
    alt="Create GitHub App form with a personal or organization owner, an app name field, and the Create App action."
    width={1872}
    height={1068}
  />
...
<Image
  src="/setup/github-app-installed.png"
  alt="Lifecycle confirmation that the GitHub App is installed, with actions to configure and restart Lifecycle or return home."
  width={1902}
  height={1088}
/>
