...
**All accessible** shows your sites and public sites.
...
When you make a public site private, Lifecycle retires its previous content URL.
Use the returned opening URL for access to the current site.
...
A content replacement preserves the current content URL.
A public-to-private change creates a fresh content URL.
...
Private sites block Web Workers, SharedWorkers, and service workers.
