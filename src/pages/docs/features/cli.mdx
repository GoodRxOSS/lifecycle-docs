...
<Callout type="info">
  ...
  placeholder hosts such as `https://app.lifecycle.example.com` and
  `myorg/myrepo` — substitute your own values.
</Callout>
...
```json
{
  ...
  "profiles": {
    "default": {
      "apiUrl": "https://app.lifecycle.example.com",
      "uiUrl": "https://ui.lifecycle.example.com",
      "authEnabled": true,
      "keycloak": {
        "issuer": "https://auth.lifecycle.example.com/realms/lifecycle",
...
lfc config add-profile staging --api-url https://staging.lifecycle.example.com --issuer <url>
