...
2. Add the redirect URIs your users' MCP clients need — CLI tools typically use a localhost
...
3. Assign the `mcp` client scope to the client (as an optional client scope).
4. Hand the client ID to your users.
