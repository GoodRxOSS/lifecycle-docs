...
verificationBaseline: "2026-09-14-sites-pending-release"
...
<Callout type="info">
  Sites access control is pending release. With compatible components, these
  tools return the user's private sites and public sites. `mineOnly` selects
  ownership rather than creator or updater email. Sites tools provide read
  access only.
</Callout>
