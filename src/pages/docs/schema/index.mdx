...
- `deployment.public`: If true, an Ingress is created for external hostname access.
...
- `github.deployment.public`: If true, an Ingress is created for external hostname access.
