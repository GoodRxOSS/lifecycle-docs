...
<Image
  src="/docs/releases/keycloak-management-client-capabilities.png"
  alt="Keycloak capability settings show client authentication and service account roles on, with interactive authentication flows off."
  width={1458}
  height={1034}
  ratio={1458 / 1034}
/>
...
<Image
  src="/docs/releases/keycloak-management-client-scope.png"
  alt="The dedicated Keycloak scope has full scope access off and only the two required realm-management roles."
  width={2300}
  height={916}
  ratio={2300 / 916}
/>
