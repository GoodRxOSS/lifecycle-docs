...
<Callout type="warning">
  The following Sites access controls are pending release.
</Callout>
...
After migration, older personal keys without the required identity binding cannot access Sites.
Create replacement personal keys through your signed-in account.
...
For sites with retired keys, see [Sites ownership limitations](/docs/features/sites#choose-who-can-access-a-site).
